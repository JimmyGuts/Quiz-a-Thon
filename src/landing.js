...
const categories = ['All', 'General Knowledge', 'Entertainment: Books', 'Entertainment: Film', 'Entertainment: Music', 'Entertainment: Musicals & Theatres', 'Entertainment: Television', 'Entertainment: Video Games', 'Entertainment: Board Games', 'Science & Nature', 'Science: Computers', 'Science: Mathematics', 'Mythology', 'Sports', 'History', 'Celebrities', 'Politics', 'Geography', 'Art', 'Animals', 'Vehicles', 'Entertainment: Comics', 'Science: Gadgets', 'Entertainmet: Cartoons'];
